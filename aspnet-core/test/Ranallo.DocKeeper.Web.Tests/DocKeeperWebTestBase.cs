...
{
    public abstract class DocKeeperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DocKeeperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DocKeeperWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DocKeeperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DocKeeperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DocKeeperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DocKeeperDbContext, Task<T>> func)
        {
            T result;
