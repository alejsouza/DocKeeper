...
export class DocumentsServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateDocumentDto | undefined): Observable<DocumentDto> {
     ...
     * @return Success
     */
    getDocuments(filter: string | null | undefined, nameFilter: string | null | undefined, locationFilter: string | null | undefined, descriptionFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetDocumentForViewDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetDocumentForViewDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetDocumentForViewDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetDocuments(response: HttpResponseBase): Observable<GetDocumentForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetDocumentForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetDocumentForViewDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: DocumentDto | undefined): Observable<DocumentDto> {
        let url_ = this.baseUrl + "/api/services/app/Documents/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<DocumentDto> {
        let url_ = this.baseUrl + "/api/services/app/Documents/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, nameFilter: string | null | undefined, locationFilter: string | null | undefined, descriptionFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DocumentDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DocumentDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DocumentDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<DocumentDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<DocumentDtoPagedResultDto>(<any>null);
    }
...
export class GetDocumentForViewDtoPagedResultDto implements IGetDocumentForViewDtoPagedResultDto {
    totalCount: number;
    items: GetDocumentForViewDto[] | undefined;

    constructor(data?: IGetDocumentForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetDocumentForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetDocumentForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetDocumentForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetDocumentForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetDocumentForViewDtoPagedResultDto {
    totalCount: number;
    items: GetDocumentForViewDto[] | undefined;
}
...
export class GetDocumentForEditOutput implements IGetDocumentForEditOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.document = _data["document"] ? CreateDocumentDto.fromJS(_data["document"]) : <any>undefined;
        }
    }
    ...
    clone(): GetDocumentForEditOutput {
        const json = this.toJSON();
        let result = new GetDocumentForEditOutput();
        result.init(json);
        return result;
